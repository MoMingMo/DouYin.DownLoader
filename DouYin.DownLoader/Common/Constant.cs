...
namespace DouYin.DownLoader.Common
{
    public class Constant
    {
        ...
        public static string AwemeMixCollectionsUrl = "https://www.douyin.com/aweme/v1/web/mix/listcollection/?device_platform=webapp&aid=6383&channel=channel_pc_web&mix_id={0}&max_cursor={1}&count=20";
